...
>
  Join the Consortium
      ...
      <div className="consortium-container">
        ...
        <h2 style={{ color: '#D15D51' , fontSize: '1rem'}}>Required Information</h2>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <strong>Voice of Somali Women (VOSW)</strong>
                <br />
                <a href="http://www.vosw.org" target="_blank" rel="noopener noreferrer">www.vosw.org</a>
              </li>
            </ul>
          </div>
        </div>
