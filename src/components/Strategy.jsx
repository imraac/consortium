...
const Strategy = () => {
  return (
    <div className="strategy-container">
      <svg className="strategy-svg" xmlns="http://www.w3.org/2000/svg">
        <rect className="strategy-rect" />
        <text x="20" y="30" className="strategy-title">Strategy Overview</text>
        
        <text x="20" y="80" className="strategy-goal">Strategic Goals</text>
