            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  ...
                  <g fill="gray">
                    <path d="M8 3C4.5 3 1.5 7 1.5 7s3 4 6.5 4 6.5-4 6.5-4S11.5 3 8 3z" />
                    <path d="M8 4a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z" />
                    <path d="M3 8s1.5-3 5-3 5 3 5 3-1.5 3-5 3-5-3-5-3z" />
                    <path d="M8 0C3.58 0 0 4.5 0 4.5S3.58 9 8 9s8-4.5 8-4.5S12.42 0 8 0zm0 8.5a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9z" />
                  </g>
                )}
              </svg>
            </div>
