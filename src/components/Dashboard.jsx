...
const Dashboard = () => {
  return (
    <div className="dashboard-container">
      <h2>
        Welcome to the Minority Rights Organizations (MRO) Consortium member
        area
      </h2>
      ...
      <div className="card-container">
        ...
        <div className="card left">
          ...
          <ul>
            <li>
              <Link to="/membership">View membership, profile and contact information</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/child-accounts">View child accounts</Link>
            </li>
            <li>
              <Link to="/request-child-removal">Request child account removal</Link>
            </li>
            <li>
              <Link to="/request-child-accounts">Request additional child account(s)</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="card left">
          <h2>Field Visits</h2>
          <p>
            Notify us when your staff will be in Somalia by logging their field
            visits.
          </p>
          <ul>
            <li>
              <Link to="/manage-field-visit">Manage a field visit</Link>
            </li>
            <li>
              <Link to="/add-field-visit">Add a field visit</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="card middle">
          <h2>Events</h2>
          <p>
            <Link to="/calendar">Manage my calendar</Link>.
          </p>
          <ul>
            <li>
              <Link to="/manage-event">Manage or create an event</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="card middle">
          <h2>Documents</h2>
          <p>
            Share key documents with other members on our key documents page,
            from minutes to press statements.
          </p>
          <ul>
            <li>
              <Link to="/manage-document">Manage a document</Link>
            </li>
            <li>
              <Link to="/add-document">Add a document</Link>
            </li>
          </ul>
        </div>
