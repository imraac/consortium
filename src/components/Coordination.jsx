    ...
    <div className="coordination-wrapper">
      ...
      <div className="text-container">
        ...
        <div className="representation-section">
          ...
          <div><h3>Information Sharing </h3>
We ensure that valuable information is shared through:
<p>• Newsletters: Providing regular updates on consortium activities, advocacy efforts, and relevant issues.
    • Reports and Publications: Sharing research findings, impact reports, and policy papers.
    • Online Resources: Maintaining a digital platform with access to essential documents and information.</p>
    </div>
        </div>
      </div>
    </div>
